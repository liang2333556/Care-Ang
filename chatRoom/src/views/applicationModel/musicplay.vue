  ...
  <div id="app">
    ...
    <div class="search-wrapper">
                       <form @submit.prevent="handleSearch" >
                           <input autofocus v-model="query" class="textbox" type="text"  placeholder="Search..." tabindex="0">
                  ...
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb d-flex justify-content-md-between justify-content-sm-center">
                      <li :class="{ 'breadcrumb-item active': genre.active, 'breadcrumb-item': !genre.active }" aria-current="page"
                        ...
                        <router-link :to="{ name: 'musicplay', query:{ genre: genre.name} }">{{ genre.name }}</router-link>
                      </li>
                    </ol>
                  </nav>
                </div>
